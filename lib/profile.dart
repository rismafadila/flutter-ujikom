...
import 'package:flutter_application_2/sample_json.dart';
          ...
          children: [
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                      colors: [Colors.brown.shade300, Colors.brown.shade300]),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.grey,
                      spreadRadius: 1,
            ...
            Card(
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient:
                      LinearGradient(colors: [Colors.brown.shade300, Colors.brown.shade300]),
                  boxShadow: [
                    BoxShadow(
                      color: Colors.grey,
                      spreadRadius: 1,
